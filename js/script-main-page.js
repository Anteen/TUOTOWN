...
const searchButtonOpen = document.querySelector (".open-menu__search");
const searchInputOpen = document.querySelector (".open-menu__search-input-field");
const searchResetOpen = document.querySelector (".open-menu__search-reset");
const combackButton = document.querySelector (".open-menu__comeback-button");
const emailButton = document.querySelector (".menu__mail-wrapper");

searchButtonOpen.addEventListener("click",  function() {
  searchInputOpen.classList.add("open-menu__search-input-field_activated")
  searchResetOpen.classList.add("open-menu__search-reset_activated")
  emailButton.classList.add("menu__mail-wrapper_activated")
});

combackButton.addEventListener("click",  function() {
  searchInputOpen.classList.remove("open-menu__search-input-field_activated")
  searchResetOpen.classList.remove("open-menu__search-reset_activated")
  emailButton.classList.remove("menu__mail-wrapper_activated")
});
